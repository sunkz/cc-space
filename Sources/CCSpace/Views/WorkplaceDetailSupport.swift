...
struct WorkplaceDetailPresentationState {
    ...
    init(
        ...
        self.supportsIDEA = supportsIDEA
        canOpenInIDEA = supportsIDEA && canOpenDirectory
...
struct WorkplaceRepositoryRowPresentationState {
    ...
    init(
        ...
        self.supportsIDEA = supportsIDEA
        canOpenInIDEA = canOpenLocalActions && supportsIDEA
